...
(
	...
	FOREIGN KEY (Dep_ID) REFERENCES MainDepartments(Dep_ID)
);

INSERT INTO IncidentTypes
	(TypeName, TypeNote,Dep_ID)
VALUES

	(N'هبوط', N'هبوط',1),
	(N'علاج كيميائى/اشعاعى', N'علاج كيميائى/اشعاعى',2),
	(N'ولادة', N'ولادة',1),
	(N'تصادم سيارة/عدة سيارات', N'تصادم سيارة/عدة سيارات',3),
	(N'نقل محافظات مستشفيات', N'نقل محافظات مستشفيات',5),
	(N'انقلاب/سقوط مركبه', N'انقلاب/سقوط مركبه',3),
	(N'نقل اجراء عمليات', N'نقل اجراء عمليات',5),
	(N'كسر', N'كسر',3),
	(N'احتباس بولى', N'احتباس بولى',1),
	(N'شكاوى', N'شكاوى',6),
	(N'حريق', N'حريق',3),
	(N'حروق', N'حروق',3),
	(N'جلطة', N'جلطة',1),
	(N'حادث طريق', N'حادث طريق',3),
	(N'حادث غرق', N'حادث غرق',3),
	(N'حضانة أكسجين', N'حضانة أكسجين',4),
	(N'حضانة تنقس صناعى', N'حضانة تنفس صناعى',4),
	(N'خدمة طبية-خدمات طبية و رعاية', N'خدمة طبية-خدمات طبية و رعاية',2),
	(N'سقوط من مرتفع', N'سقوط من مرتفع',3),
	(N'ارتفاع درجة الحرارة', N'ارتفاع درجة الحرارة',1),
	(N'ارتفاع ضغط الدم', N'ارتفاع ضغط الدم',1),
	(N'أزمة قلبية', N'أزمة قلبية',1),
	(N'غسبل كلوي', N'غسبل كلوي',2),
	(N'غيبوبة/اغماء', N'غيبوبة/اغماء',1),
	(N'قئ دموى', N'قئ دموى',1),
	(N'قئ و اسهال', N'قئ و اسهال',1),
	(N'متابعة مستشفى', N'متابعة مستشفى',2),
	(N'مشاجرة/اعتداء', N'مشاجرة/اعتداء',1),
	(N'مخص كلوي/معوي', N'مخص كلوي/معوي',1),
	(N'نزيف', N'نزيف',1),
	(N'اشتعال سيارة', N'اشتعال سيارة',3),
	(N'ألم بالصدر', N'ألم بالصدر',1),
	(N'نقل اخر خدمات مصاحبة', N'نقل اخر خدمات مصاحبة',5),
	(N'نقل أشعة/عيادات/تحاليل', N'نقل أشعة/عيادات/تحاليل',5),
	(N'نقل للأشعة أو التحاليل', N'نقل للأشعة أو التحاليل',5),
	(N'نقل محافظات/سفريات', N'نقل محافظات/سفريات',5),
	(N'نقل من سكن الى سكن', N'نقل من سكن الى سكن',5),
	(N'نقل من سكن الى مستشفى', N'نقل من سكن الى مستشفى',5),
	(N'نقل من مستشفى للسكن', N'نقل من مستشفى للسكن',5),
	(N'نقل من مستشفى الى مستشفى', N'نقل من مستشفى الى مستشفى',5),
	...
	(N'غريق', N'غريق',3),
	(N'استفسارات عن مفقودات', N'استفسارات عن مفقودات',6),
	(N'استفسارات عن مفقودين', N'استفسارات عن مفقودين',6),
	(N'استفسارات أخرى', N'استفسارات أخرى',6),
	(N'أخرى', N'أخرى',6),
	(N'خدمة طبية-خدمات طبية و رعاية',N'خدمة طبية-خدمات طبية و رعاية',2)
